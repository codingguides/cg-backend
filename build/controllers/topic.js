...
exports.TopicController.get('/get-menu', async (request, response, next) => {
    try {
...
exports.TopicController.get('/get-quiz-list/:slug', async (request, response, next) => {
    try {
...
exports.TopicController.get('/quiz/:slug', async (request, response, next) => {
    try {
        const { slug } = request.params;
        var ObjectId = require('mongodb').ObjectId;
        await models_1.TopicModel.findOne({ "slug": slug }).then(async (val) => {
